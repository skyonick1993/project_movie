...
const Contact = (props) => {
  return (
    <div className="w-full h-screen text-black text-center">
      ...
      >
        <div>
          <div className="max-w-screen-xl px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-black rounded-lg shadow-lg bg-opacity-5">
            <div className="flex flex-col justify-between">
              <div>
                <h2 className="text-4xl lg:text-5xl font-bold leading-tight">
                  Contact us about everything!
                </h2>
                <div className="text-black text-2xl lg:text-3xl font-bold mt-4">
            ...
            <form className="text-left">
              <div>
                <span className="uppercase text-base text-black font-bold">
                  Full Name
                </span>
                <input
                  className="w-full bg-gray-200 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-indigo-500"
                  type="text"
                  name="fullName"
                  placeholder
                />
              ...
              <div className="mt-8">
                ...
                <textarea
                  className="w-full h-32 bg-gray-200 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-indigo-500"
                  defaultValue={""}
                  name="message"
                />
              </div>
